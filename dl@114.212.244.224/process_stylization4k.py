...
def stylization4k(p_wct, content_image_path, style_image_path, content_seg_path, style_seg_path, output_image_path,
                cuda):
    # Load image
    ...
    #   out_img = smooth_filter(output_image_path, content_image_path, f_radius=5, f_edge=1e-1)
    #out_img.save(output_image_path)
